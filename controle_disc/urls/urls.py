...
urlpatterns = [
    ...
    path('alunos/<int:aluno_id>/', AlunoDetail.as_view(), name='aluno-detail'),

    # URLs para Disciplina
    path('disciplinas/', DisciplinaListView.as_view(), name='disciplina-list'),
    path('disciplinas/<int:disciplina_id>/', DisciplinaDetailView.as_view(), name='disciplina-detail'),

    # URLs para Tarefa
    path('tarefas/', TarefaListView.as_view(), name='tarefa-list'),
    path('tarefas/<int:tarefa_id>/', TarefaDetailView.as_view(), name='tarefa-detail'),
